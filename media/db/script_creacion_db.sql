...
CREATE TABLE IF NOT EXISTS "topx"(
    ...
    "prezo"                             TEXT NOT NULL,
    "market_cap"                        TEXT,
    "market_cap_by_total_supply"        TEXT,
    ...
    "price_change_pctx_14d_divisa_ref"  TEXT,
    "price_change_pctx_30d_divisa_ref"  TEXT,
    "price_change_pctx_60d_divisa_ref"  TEXT,
    "price_change_pctx_90d_divisa_ref"  TEXT,
    "price_change_pctx_200d_divisa_ref" TEXT,
    "price_change_pctx_365d_divisa_ref" TEXT,
    "roi"                               TEXT,
    "turnover"                          TEXT,
    "dominancia"                        TEXT,
    "market_pair_count"                 TEXT,
